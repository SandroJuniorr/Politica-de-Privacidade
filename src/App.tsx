  ...
  return (
    <div className="container">
      <div>
        ...
        <p>
          A sua privacidade é importante para nós. É política da Mister Àgil
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar nos nossos apps e outros sites que possuímos e
          operamos.
        </p>
        <p>
        ...
        <p>
          Os nossos site ou apps pode ter links para sites externos que não são
        ...
        <p>
          ...
          informação que o Mister Ágil oferece no site ou app e com caráter
        ...
        <ul>
          ...
          <li>
            ...
            (softwares) do Paulo Resolve, de seus fornecedores ou terceiros,
        ...
        <p>
          ...
          <strong> Fev</strong>/<strong> 2023</strong>.
        </p>
      </div>
    </div>
  );
